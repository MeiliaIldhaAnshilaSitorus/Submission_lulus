...
data_day_path = os.path.join(current_directory, "data_day.csv")
data_hour_path = os.path.join(current_directory, "data_hour.csv")
df_day = pd.read_csv(data_day_path)
df_hour = pd.read_csv(data_hour_path)
